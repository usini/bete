...
const STRINGS = {
  en: {
    ...
    'update.webApplying': '⟳ Update applied, reloading…',
    ...
    'radial.makeSign': 'Turn into a sign',
    'radial.makeRect': 'Turn into a rectangle',
    'radial.circle': 'Circle',
    'radial.hexagon': 'Hexagon',
    'radial.connector': 'Connector',
    'radial.editProgram': 'Program',
    'radial.makeSwitch': 'Turn into a switch',
    'radial.makeReadout': 'Turn into a readout',
    'radial.makeClock': 'Turn into a clock',
    'radial.clockFormat': 'Clock format',
    'radial.startStopwatch': 'Start',
    'radial.pauseStopwatch': 'Pause',
    'radial.resetStopwatch': 'Reset stopwatch',
    'radial.setCountdown': 'Set countdown target',
    'radial.bridgeOn': '☁ Network bridge',
    'radial.bridgeOff': '☁ Stop network bridge',
    ...
    'alert.yamlInvalid': 'Invalid YAML',
    'connector.title': 'Program this connector',
    'connector.save': 'Save',
    'connector.cancel': 'Cancel',
    'connector.on': 'ON',
    'connector.off': 'OFF',
    'bridge.warnTitle': '⚠ Share this local device?',
    'bridge.warnBody': 'Anyone connected to this board will be able to flip this switch on your local network, without ever seeing its address or credentials.',
    'bridge.confirm': 'Enable bridge',
    'clock.formatTitle': 'Clock format',
    'clock.HH:MM': 'HH:MM',
    'clock.HH:MM:SS': 'HH:MM:SS',
    'clock.HH:MM:SS+DATE': 'HH:MM:SS + Date',
    'clock.DAY': 'Day (Monday)',
    'clock.FULLDATE': 'Full date (Monday July 12 2026)',
    'clock.STOPWATCH': 'Stopwatch',
    'clock.COUNTDOWN': 'Countdown',
    'clock.paused': 'PAUSED',
    'clock.noTarget': 'NO TARGET SET',
    'clock.reached': 'REACHED',
    ...
    'settings.version': 'Bete desktop v{v}',
    ...
    'settings.exportHtml': '⭳ Export as HTML (read-only viewer)',
  ...
  fr: {
    ...
    'update.webApplying': '⟳ Mise à jour appliquée, rechargement…',
    ...
    'radial.text': 'Texte',
    'radial.rectangle': 'Rectangle',
    'radial.makeSign': 'Transformer en pancarte',
    'radial.makeRect': 'Transformer en rectangle',
    'radial.circle': 'Cercle',
    'radial.hexagon': 'Hexagone',
    'radial.connector': 'Connecteur',
    'radial.editProgram': 'Programmer',
    'radial.makeSwitch': 'Transformer en interrupteur',
    'radial.makeReadout': 'Transformer en afficheur',
    'radial.makeClock': 'Transformer en horloge',
    'radial.clockFormat': "Format de l'horloge",
    'radial.startStopwatch': 'Démarrer',
    'radial.pauseStopwatch': 'Pause',
    'radial.resetStopwatch': 'Réinitialiser le chrono',
    'radial.setCountdown': 'Régler le compte à rebours',
    'radial.bridgeOn': '☁ Pont réseau',
    'radial.bridgeOff': '☁ Arrêter le pont réseau',
    'radial.liaison': 'Liaison',
    'radial.undo': 'Annuler',
    ...
    'alert.yamlInvalid': 'YAML invalide',
    'connector.title': 'Programmer ce connecteur',
    'connector.save': 'Enregistrer',
    'connector.cancel': 'Annuler',
    'connector.on': 'ON',
    'connector.off': 'OFF',
    'bridge.warnTitle': '⚠ Partager cet appareil local ?',
    'bridge.warnBody': "Toute personne connectée à ce board pourra actionner cet interrupteur sur ton réseau local, sans jamais voir son adresse ni ses identifiants.",
    'bridge.confirm': 'Activer le pont',
    'clock.formatTitle': "Format de l'horloge",
    'clock.HH:MM': 'HH:MM',
    'clock.HH:MM:SS': 'HH:MM:SS',
    'clock.HH:MM:SS+DATE': 'HH:MM:SS + Date',
    'clock.DAY': 'Jour (Lundi)',
    'clock.FULLDATE': 'Date complète (Lundi 12 juillet 2026)',
    'clock.STOPWATCH': 'Chronomètre',
    'clock.COUNTDOWN': 'Compte à rebours',
    'clock.paused': 'PAUSE',
    'clock.noTarget': 'AUCUNE CIBLE REGLEE',
    ...
    'settings.exportHtml': '⭳ Exporter en HTML (lecture seule)',

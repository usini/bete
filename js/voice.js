...
import { state, newId, scheduleSave } from './state.js?v=mr7jvkrx';
import { reset } from './physics.js?v=mr7jvkrx';
import { putAudio, getAudio, delAudio } from './audio.js?v=mr7jvkrx';
import { shareAudio, requestAudio } from './sync.js?v=mr7jvkrx';
import { t } from './i18n.js?v=mr7jvkrx';
import { acquireStream } from './voicechat.js?v=mr7jvkrx';

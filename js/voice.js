...
import { state, newId, scheduleSave } from './state.js?v=mr6ox2uf';
import { reset } from './physics.js?v=mr6ox2uf';
import { putAudio, getAudio, delAudio } from './audio.js?v=mr6ox2uf';
import { shareAudio, requestAudio } from './sync.js?v=mr6ox2uf';
import { t } from './i18n.js?v=mr6ox2uf';
import { acquireStream } from './voicechat.js?v=mr6ox2uf';

...
import { state, newId, scheduleSave } from './state.js?v=mr7mutc2';
import { reset } from './physics.js?v=mr7mutc2';
import { putAudio, getAudio, delAudio } from './audio.js?v=mr7mutc2';
import { shareAudio, requestAudio } from './sync.js?v=mr7mutc2';
import { t } from './i18n.js?v=mr7mutc2';
import { acquireStream } from './voicechat.js?v=mr7mutc2';

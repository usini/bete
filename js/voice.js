...
import { state, newId, scheduleSave } from './state.js?v=mr7mfvqi';
import { reset } from './physics.js?v=mr7mfvqi';
import { putAudio, getAudio, delAudio } from './audio.js?v=mr7mfvqi';
import { shareAudio, requestAudio } from './sync.js?v=mr7mfvqi';
import { t } from './i18n.js?v=mr7mfvqi';
import { acquireStream } from './voicechat.js?v=mr7mfvqi';

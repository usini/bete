...
import { state, newId, scheduleSave } from './state.js?v=mr6jcn8i';
import { reset } from './physics.js?v=mr6jcn8i';
import { putAudio, getAudio, delAudio } from './audio.js?v=mr6jcn8i';
import { shareAudio, requestAudio } from './sync.js?v=mr6jcn8i';
import { t } from './i18n.js?v=mr6jcn8i';
import { acquireStream } from './voicechat.js?v=mr6jcn8i';

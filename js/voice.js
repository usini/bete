...
import { state, newId, scheduleSave } from './state.js?v=mr6okg0j';
import { reset } from './physics.js?v=mr6okg0j';
import { putAudio, getAudio, delAudio } from './audio.js?v=mr6okg0j';
import { shareAudio, requestAudio } from './sync.js?v=mr6okg0j';
import { t } from './i18n.js?v=mr6okg0j';
import { acquireStream } from './voicechat.js?v=mr6okg0j';

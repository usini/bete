...
import { state, newId, scheduleSave } from './state.js?v=mr6hrnjr';
import { reset } from './physics.js?v=mr6hrnjr';
import { putAudio, getAudio, delAudio } from './audio.js?v=mr6hrnjr';
import { shareAudio, requestAudio } from './sync.js?v=mr6hrnjr';
import { t } from './i18n.js?v=mr6hrnjr';
import { acquireStream } from './voicechat.js?v=mr6hrnjr';

...
import { state, newId, scheduleSave } from './state.js?v=mrcjc0bj';
import { reset } from './physics.js?v=mrcjc0bj';
import { putAudio, getAudio, delAudio } from './audio.js?v=mrcjc0bj';
import { shareAudio, requestAudio } from './sync.js?v=mrcjc0bj';
import { t } from './i18n.js?v=mrcjc0bj';
import { acquireStream } from './voicechat.js?v=mrcjc0bj';
